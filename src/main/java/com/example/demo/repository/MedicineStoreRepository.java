...
public interface MedicineStoreRepository extends CrudRepository<MedicineStore, Integer>{
	...
	Optional<MedicineStore> findBymedicinename(String medicinename);
	
	@Modifying(clearAutomatically = true)
	@Query("UPDATE MedicineStore ms SET ms.quantity=:quantity WHERE ms.medicinename=:medicineName")
